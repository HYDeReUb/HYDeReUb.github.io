...
CREATE TABLE `bk_1_new` (
  `bk_dummy` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- 資料表結構 `bk_ksu_std_table`
--
...
--
-- 資料表結構 `bk_std_names_table`
--

CREATE TABLE `bk_std_names_table` (
...
('IE01', 'John Sieg', 33, 'IE', '2019-11-12', 100),
...
('4040w1', 'John1', 22, 'CS', '2019-12-05', 100),
('2323E1', '1John', 44, 'QQ', '2019-12-04', 100);
...
('4080E001', 'John Sieg', 'HA', 910971234, '2201 ksyline Dr. Ha city', 'IE', 99, ''),
('4080E002', 'John Mike', 'HA', 910971255, '2250 ksyline Dr. Ha city', 'IE', 91, ''),
('4080E003', 'Mike Jim', 'HA', 0, '', 'IM', 80, 'T01'),
('4080E004', 'Mike Jim', 'HA', 0, '', 'IM', 85, 'T01');
